...
const fleetConfortPlus = [
  {
    name: "Mercedes Classe AMG",
    passengers: "4 passagers",
    features: "Clim · WiFi · GPS · Eau",
    image: "/images/fleet/amg.jpg",
  },
  {
    name: "Toyota Highlander",
    passengers: "6 passagers",
    features: "Clim · WiFi · GPS · Eau",
    image: "/images/fleet/highlander.jpg",
  },
  {
    name: "Lexus RX",
    ...
    <section id="fleet" className="section-padding bg-obsidian-900">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 lg:mb-20">
          <span className="section-label block mb-4">Nos Véhicules</span>
          <h2 className="section-title text-white mb-4">
            Notre{" "}
            <span className="text-gold-500 italic">Flotte</span>
          </h2>
...
function FleetCard({ car }: { car: (typeof fleetConfort)[0] }) {
  return (
